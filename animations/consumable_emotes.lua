return {
            ...
            Props = {
                {
                    ...
                    Placement = {
                        vector3(0.000000, -0.050000, 0.000000),
            ...
            Props = {
                {
                    ...
                    Name = "prop_cs_bs_cup",
                    Placement = {
                        vector3(0.000000, -0.100000, 0.000000),
                        vector3(0.000000, 0.000000, 0.000000),
                    },
                },
            },
            ...
            Props = {
                {
                    ...
                    Placement = {
                        vector3(-0.050000, 0.030000, -100.000000),
    ...
    {
        Label = 'Burger Shot Refrigerante',
        Command = 'bsrefri',
        Animation = 'loop_bottle',
        Dictionary = 'mp_player_intdrink',
        Options = {
    ...
    },
    {
        ...
        Command = "comer",
        Animation = "idle_c",
        Dictionary = "amb@code_human_wander_eating_donut@male@idle_a",
        Options = {
            Flags = {
                Move = false,
                Loop = false,
            ...
            Props = {
                {
                    ...
                    Placement = {
                        vector3(0.050000, 0.020000, -50.000000),
                        vector3(16.000000, 60.000000, 0.000000),
                    },
                },
            },
        },
            ...
            Props = {
                {
                    ...
                    Name = "prop_taco_01",
                    Placement = {
                        vector3(0.060000, 0.020000, -50.000000),
                        vector3(220.000000, 60.000000, 0.000000),
                    },
                },
            },
        },
    ...
    {
        Label = 'Sanduíche de Marshmallow',
        Command = 'comer12',
        Animation = 'mp_player_int_eat_burger',
        Dictionary = 'mp_player_inteat@burger',
        Options = {
    ...
    },
    {
        ...
        Options = {
            ...
            Props = {
                {
                    Bone = 28422,
                    Name = "prop_food_bs_juice03",
                    Placement = {
                        vector3(-0.010000, -0.150000, 0.000000),
                        vector3(0.000000, 0.000000, 0.000000),
                    },
                },
            },
    ...
    },
    {
        ...
        Command = "cafe",
        Animation = "base",
        Dictionary = "amb@world_human_aa_coffee@base",
        Options = {
            Flags = {
                Move = false,
                Loop = false,
    ...
    },
    {
        ...
        Command = "cafe2",
        Animation = "idle_a",
        Dictionary = "amb@world_human_aa_coffee@idle_a",
        Options = {
            Flags = {
                Move = false,
                Loop = false,
    ...
    {
        Label = 'Bengala Doce Vermelha',
        Command = 'bengaladoce2',
        Animation = 'mp_player_int_eat_burger',
        Dictionary = 'mp_player_inteat@burger',
        Options = {
            Flags = {
    ...
    {
        Label = 'Bengala Doce Roxa',
        Command = 'bengaladoce3',
        Animation = 'mp_player_int_eat_burger',
        Dictionary = 'mp_player_inteat@burger',
        Options = {
            Flags = {
    ...
    {
        Label = 'Bengala Doce Amarela',
        Command = 'bengaladoce4',
        Animation = 'mp_player_int_eat_burger',
        Dictionary = 'mp_player_inteat@burger',
        Options = {
            Flags = {
    ...
    {
        Label = 'Bengala Doce Azul',
        Command = 'bengaladoce5',
        Animation = 'mp_player_int_eat_burger',
        Dictionary = 'mp_player_inteat@burger',
        Options = {
            Flags = {
